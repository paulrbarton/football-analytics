"""
Script to scrape all Premier League teams.
...
def main():
    """Scrape all Premier League teams and upload to configured destination."""
    ...
    if not all_df.empty:
        ...
        scraper.save_data(
            all_df,
            f'premier_league_{SEASON.replace("-", "_")}_all_teams',
            format='csv',
            destination='local'
        )
